...
const Language = () => {
  ...
  const TR = <p id="Dil"><span style={{color: (theme===true ? "#4731D3" : "#BAB2E7") }} id="DilAdi">TÜRKÇE</span>'YE GEÇ</p>;
  const ENG = <p id="Dil"><span style={{color: (theme===true ? "#4731D3" : "#BAB2E7") }} id="DilAdi">ENGLISH</span></p>;
  return (
    <div id="languageMain">
